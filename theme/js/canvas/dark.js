function dark() {
    ...
    var n, e, i, h, t = .05, s = document.getElementById("universe"), o = !0, d = "226,225,224", c = [];
    function f() {
        n = window.innerWidth,
    ...
    function y() {
        this.reset = function() {
            ...
            this.y = l(0, e),
            this.r = l(1.1, 2.6),
            this.dx = l(t, 6 * t) + (this.comet + 1 - 1) * t * l(50, 120) + .1,
        ...
        this.draw = function() {
            if (h.beginPath(),
            this.giant)
                h.fillStyle = "rgba(180,184,240," + this.opacity + ")",
                ...
                h.fillStyle = "rgba(226,225,142," + this.opacity + ")",
    ...
    function t() {
        "dark" == document.getElementsByTagName("html")[0].getAttribute("data-theme") && u(),
